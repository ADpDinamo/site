...
)  # (adpd/config/settings/base.py - 3 = adpd/)
...
MIGRATION_MODULES = {"sites": "adpd.contrib.sites.migrations"}
...
ADMINS = [("""Dragos Nicu""", "contact@dragosnicu.com")]
